...
public class AddressBook {
	public static HashMap<String, ArrayList<ContactPerson>> city = new HashMap<String, ArrayList<ContactPerson>>();
	public static HashMap<String, ArrayList<ContactPerson>> state = new HashMap<String, ArrayList<ContactPerson>>();
	...
	public void displayContents() {
		...
		for (String eachContact : contactList.keySet()) {
			ContactPerson contact = contactList.get(eachContact);
	...
	public void writeDataToCSVFile() {
		try (Writer writer = Files.newBufferedWriter(Paths.get("book1Contact.csv"))) {
			StatefulBeanToCsvBuilder<ContactPerson> contactsStatefulBeanToCsvBuilder = new StatefulBeanToCsvBuilder<>(writer);
			StatefulBeanToCsv<ContactPerson> contactStatefulBeanToCsv = contactsStatefulBeanToCsvBuilder.build();
	...
	public void readDataFromCSVFile() {
		try (Reader reader = Files.newBufferedReader(Paths.get("book1Contact.csv"));
	...
	public void writeDataToJSONFile() {
		try (Writer writer = Files.newBufferedWriter(Paths.get("book1Contact.json"))) {
			Gson gson = new Gson();
	...
	public void readDataFromJSONFile() {
		try (Reader reader = Files.newBufferedReader(Paths.get("book1Contact.json"))) {
